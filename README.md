...
국내 홈페이지 디자인 중에서는 그 정도로 스크롤 기능에 따라 정보가 자연스레 들어오는 인터랙티브 디자인의 경험은 본 적이 없어서 인상이 깊었다.<br>
...
그동안 공부해왔던 udemy의 인강들을 개인적으로 정리한 문서들과 구글링 그리고 ChatGpt 3.5의 활용을 전반적으로 적극적으로 하였다.<br>
...
특히 useState나 useEffect의 기능들은 참고를 많이 하였는데, 쓰인 기능들과 Hook을 밑바닥부터 아무 도움 없이 혼자서 스스로 구현하는 것은 아직 많이 부족한 것을 체감 느꼈고,<br>
뭔가 각 쓰인 함수나 로직이나 알고리즘에 대해서는 따로따로 하나씩 보면 이해가 가기도 하고 이해를 하려고 최대한 노력했지만, 뭔가 약간 부족하게 이해가 된 느낌이었다.<br>
...
확실한 건 처음 인강을 들을 때보다는 여러모로 한 걸음 더 성장한 것 같다.<br>
<br>
분명하게.<br>
<br>
<br>
